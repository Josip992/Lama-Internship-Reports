...
Handlebars.registerHelper('groupData', function(list, groupBy, printBy, ...additionalFields) {
    return list.reduce((r, a) => {
        let obj = {printBy: a[printBy]};
        additionalFields.forEach(field => {
            obj[field] = a[field];
        });
        r[a[groupBy]] = [...r[a[groupBy]] || [], obj];
        return r;
    }, {});
});

Handlebars.registerHelper('mathFloor', function(float) {
